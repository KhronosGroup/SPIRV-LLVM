; The following SPIR 2.0 was obtained via:
; bash$ export PATH_TO_INCLUDE= $PATH_TO_GEN/lib/clang/3.6.1/include
; bash$ $PATH_TO_GEN/bin/clang -cc1 -x cl -cl-std=CL2.0 -triple spir64-unknonw-unknown -emit-llvm -include opencl-20.h repro.cl -o pipe_builtins.ll
...
; CHECK: @_Z10write_pipePU3AS18ocl_pipePU3AS4vjj
; CHECK: @_Z9read_pipePU3AS18ocl_pipePU3AS4vjj

; CHECK: @_Z18reserve_write_pipePU3AS18ocl_pipejjj

; CHECK: @_Z10write_pipePU3AS18ocl_pipe13ocl_reserveidjPU3AS4vjj
; CHECK: @_Z17commit_write_pipePU3AS18ocl_pipe13ocl_reserveidjj

; CHECK: @_Z20get_pipe_max_packetsPU3AS18ocl_pipejj
; CHECK: @_Z20get_pipe_num_packetsPU3AS18ocl_pipejj

; CHECK: @_Z17reserve_read_pipePU3AS18ocl_pipejjj

; CHECK: @_Z9read_pipePU3AS18ocl_pipe13ocl_reserveidjPU3AS4vjj
; CHECK: @_Z16commit_read_pipePU3AS18ocl_pipe13ocl_reserveidjj

; CHECK: @_Z29work_group_reserve_write_pipePU3AS18ocl_pipejjj
; CHECK: @_Z28work_group_commit_write_pipePU3AS18ocl_pipe13ocl_reserveidjj
; CHECK: @_Z28work_group_reserve_read_pipePU3AS18ocl_pipejjj
; CHECK: @_Z27work_group_commit_read_pipePU3AS18ocl_pipe13ocl_reserveidjj

; CHECK: @_Z28sub_group_reserve_write_pipePU3AS18ocl_pipejjj
; CHECK: @_Z27sub_group_commit_write_pipePU3AS18ocl_pipe13ocl_reserveidjj
; CHECK: @_Z27sub_group_reserve_read_pipePU3AS18ocl_pipejjj
; CHECK: @_Z26sub_group_commit_read_pipePU3AS18ocl_pipe13ocl_reserveidjj
...
entry:
  ...
  %2 = tail call i32 @_Z10write_pipePU3AS110ocl_pipe_tPU3AS4vi(%opencl.pipe_t addrspace(1)* %out_pipe, i8 addrspace(4)* %1, i32 4, i32 4) #2
  ret void
}

declare spir_func i64 @_Z13get_global_idj(i32) #1

declare i32 @_Z10write_pipePU3AS110ocl_pipe_tPU3AS4vi(%opencl.pipe_t addrspace(1)*, i8 addrspace(4)*, i32, i32)
...
entry:
  ...
  %0 = bitcast i32 addrspace(1)* %arrayidx to i8 addrspace(1)*
  %1 = addrspacecast i8 addrspace(1)* %0 to i8 addrspace(4)*
  %2 = tail call i32 @_Z9read_pipePU3AS110ocl_pipe_tPU3AS4vi(%opencl.pipe_t addrspace(1)* %in_pipe, i8 addrspace(4)* %1, i32 4, i32 4) #2
  ret void
}

declare i32 @_Z9read_pipePU3AS110ocl_pipe_tPU3AS4vi(%opencl.pipe_t addrspace(1)*, i8 addrspace(4)*, i32, i32)

; Function Attrs: nounwind
define spir_kernel void @test_pipe_write(i32 addrspace(1)* %src, %opencl.pipe_t addrspace(1)* %out_pipe) #0 {
entry:
  %call = tail call spir_func i64 @_Z13get_global_idj(i32 0) #2
  %0 = tail call %opencl.reserve_id_t* @_Z18reserve_write_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)* %out_pipe, i32 1, i32 4, i32 4) #2
...
if.then:                                          ; preds = %entry
  ...
  %3 = tail call i32 @_Z10write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_tjPU3AS4vi(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %0, i32 0, i8 addrspace(4)* %2, i32 4, i32 4) #2
  tail call void @_Z17commit_write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %0, i32 4, i32 4) #2
  br label %if.end
...
declare %opencl.reserve_id_t* @_Z18reserve_write_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)*, i32, i32, i32)

declare spir_func zeroext i1 @_Z19is_valid_reserve_id13ocl_reserveid(%opencl.reserve_id_t*) #1

declare i32 @_Z10write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_tjPU3AS4vi(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i8 addrspace(4)*, i32, i32)

declare void @_Z17commit_write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32)
...
entry:
  %0 = tail call i32 @_Z20get_pipe_max_packetsPU3AS110ocl_pipe_ti(%opencl.pipe_t addrspace(1)* %out_pipe, i32 4, i32 4) #2
  store i32 %0, i32 addrspace(1)* %max_packets, align 4, !tbaa !35
  %1 = tail call i32 @_Z20get_pipe_num_packetsPU3AS110ocl_pipe_ti(%opencl.pipe_t addrspace(1)* %out_pipe, i32 4, i32 4) #2
  store i32 %1, i32 addrspace(1)* %num_packets, align 4, !tbaa !35
  ret void
}

declare i32 @_Z20get_pipe_max_packetsPU3AS110ocl_pipe_ti(%opencl.pipe_t addrspace(1)*, i32, i32)

declare i32 @_Z20get_pipe_num_packetsPU3AS110ocl_pipe_ti(%opencl.pipe_t addrspace(1)*, i32, i32)

; Function Attrs: nounwind
define spir_kernel void @test_pipe_read(%opencl.pipe_t addrspace(1)* %in_pipe, i32 addrspace(1)* %dst) #0 {
entry:
  %call = tail call spir_func i64 @_Z13get_global_idj(i32 0) #2
  %0 = tail call %opencl.reserve_id_t* @_Z17reserve_read_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)* %in_pipe, i32 1, i32 4, i32 4) #2
  %call1 = tail call spir_func zeroext i1 @_Z19is_valid_reserve_id13ocl_reserveid(%opencl.reserve_id_t* %0) #2
  br i1 %call1, label %if.then, label %if.end
...
if.then:                                          ; preds = %entry
  ...
  %1 = bitcast i32 addrspace(1)* %arrayidx to i8 addrspace(1)*
  %2 = addrspacecast i8 addrspace(1)* %1 to i8 addrspace(4)*
  %3 = tail call i32 @_Z9read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_tjPU3AS4vi(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %0, i32 0, i8 addrspace(4)* %2, i32 4, i32 4) #2
  tail call void @_Z16commit_read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %0, i32 4, i32 4) #2
  br label %if.end
...
declare %opencl.reserve_id_t* @_Z17reserve_read_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)*, i32, i32, i32)

declare i32 @_Z9read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_tjPU3AS4vi(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i8 addrspace(4)*, i32, i32)

declare void @_Z16commit_read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32)
...
entry:
  ...
  %1 = tail call %opencl.reserve_id_t* @_Z29work_group_reserve_write_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)* %out_pipe, i32 %0, i32 1, i32 4) #2
...
if.then:                                          ; preds = %entry
  ...
  %5 = tail call i32 @_Z10write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_tjPU3AS4vi(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %2, i32 %4, i8 addrspace(4)* %3, i32 1, i32 4) #2
  %6 = load %opencl.reserve_id_t* addrspace(3)* @test_pipe_workgroup_write_char.res_id, align 8, !tbaa !39
  tail call void @_Z28work_group_commit_write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %6, i32 1, i32 4) #2
  br label %if.end
...
declare %opencl.reserve_id_t* @_Z29work_group_reserve_write_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)*, i32, i32, i32)

declare spir_func i64 @_Z12get_local_idj(i32) #1

declare void @_Z28work_group_commit_write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32)
...
entry:
  ...
  %call1 = tail call spir_func i64 @_Z14get_local_sizej(i32 0) #2
  %0 = trunc i64 %call1 to i32
  %1 = tail call %opencl.reserve_id_t* @_Z28work_group_reserve_read_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)* %in_pipe, i32 %0, i32 1, i32 4) #2
...
if.then:                                          ; preds = %entry
  ...
  %3 = addrspacecast i8 addrspace(1)* %arrayidx to i8 addrspace(4)*
  %4 = trunc i64 %call3 to i32
  %5 = tail call i32 @_Z9read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_tjPU3AS4vi(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %2, i32 %4, i8 addrspace(4)* %3, i32 1, i32 4) #2
  %6 = load %opencl.reserve_id_t* addrspace(3)* @test_pipe_workgroup_read_char.res_id, align 8, !tbaa !39
  tail call void @_Z27work_group_commit_read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %6, i32 1, i32 4) #2
  br label %if.end
...
declare %opencl.reserve_id_t* @_Z28work_group_reserve_read_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)*, i32, i32, i32)

declare void @_Z27work_group_commit_read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32)
...
entry:
  ...
  %0 = tail call %opencl.reserve_id_t* @_Z28sub_group_reserve_write_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)* %out_pipe, i32 %call1, i32 4, i32 4) #2
...
if.then:                                          ; preds = %entry
  ...
  %1 = bitcast i32 addrspace(1)* %arrayidx to i8 addrspace(1)*
  %2 = addrspacecast i8 addrspace(1)* %1 to i8 addrspace(4)*
  %3 = tail call i32 @_Z10write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_tjPU3AS4vi(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %0, i32 %call3, i8 addrspace(4)* %2, i32 4, i32 4) #2
  tail call void @_Z27sub_group_commit_write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)* %out_pipe, %opencl.reserve_id_t* %0, i32 4, i32 4) #2
  br label %if.end
...
declare %opencl.reserve_id_t* @_Z28sub_group_reserve_write_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)*, i32, i32, i32)

declare spir_func i32 @_Z22get_sub_group_local_idv() #1

declare void @_Z27sub_group_commit_write_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32)
...
entry:
  %call = tail call spir_func i64 @_Z13get_global_idj(i32 0) #2
  %call1 = tail call spir_func i32 @_Z18get_sub_group_sizev() #2
  %0 = tail call %opencl.reserve_id_t* @_Z27sub_group_reserve_read_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)* %in_pipe, i32 %call1, i32 4, i32 4) #2
  %call2 = tail call spir_func zeroext i1 @_Z19is_valid_reserve_id13ocl_reserveid(%opencl.reserve_id_t* %0) #2
  br i1 %call2, label %if.then, label %if.end
...
if.then:                                          ; preds = %entry
  ...
  %1 = bitcast i32 addrspace(1)* %arrayidx to i8 addrspace(1)*
  %2 = addrspacecast i8 addrspace(1)* %1 to i8 addrspace(4)*
  %3 = tail call i32 @_Z9read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_tjPU3AS4vi(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %0, i32 %call3, i8 addrspace(4)* %2, i32 4, i32 4) #2
  tail call void @_Z26sub_group_commit_read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)* %in_pipe, %opencl.reserve_id_t* %0, i32 4, i32 4) #2
  br label %if.end
...
declare %opencl.reserve_id_t* @_Z27sub_group_reserve_read_pipePU3AS110ocl_pipe_tji(%opencl.pipe_t addrspace(1)*, i32, i32, i32)

declare void @_Z26sub_group_commit_read_pipePU3AS110ocl_pipe_t16ocl_reserve_id_ti(%opencl.pipe_t addrspace(1)*, %opencl.reserve_id_t*, i32, i32)
