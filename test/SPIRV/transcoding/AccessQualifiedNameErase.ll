...
; CHECK-SPIRV: TypeInt [[typeint:[0-9]+]]
; CHECK-SPIRV: TypeVector [[typevector:[0-9]+]] [[typeint]] {{[0-9]+}}
; CHECK-SPIRV: ImageQuerySizeLod [[typevector]]

; CHECK-LLVM: call spir_func <2 x i32> @_Z13get_image_dim16ocl_image2darray(%opencl.image2d_array_t addrspace(1)*

; ModuleID = '../sample_kernel.cl'
...
entry:
  %input.addr = alloca %opencl.image2d_array_ro_t addrspace(1)*, align 8
  %offset = alloca i32, align 4
  store %opencl.image2d_array_ro_t addrspace(1)* %input, %opencl.image2d_array_ro_t addrspace(1)** %input.addr, align 8
  %0 = load %opencl.image2d_array_ro_t addrspace(1)** %input.addr, align 8
  %call = call spir_func i32 @_Z15get_image_width20ocl_image2d_array_ro(%opencl.image2d_array_ro_t addrspace(1)* %0) #2
